...
| CI/CD | [ci-cd-pipeline-builder](../skills/ci-cd-pipeline-builder/) | CI/CD 流水线构建 | ✅ |
...
| Skill | 路径 | 说明 | 状态 |
|-------|------|------|------|
| Claude Code 控制 | [openclaw-claude-code](../skills/openclaw-claude-code/) | Claude Code MCP 协议控制 | ✅ |
