...
description: '内容驱动封面生成：从文章标题/核心观点自动生成视觉隐喻提示词，调用 relay-image-gen 出图。 每张封面3秒内传达文章核心观点，杜绝通用背景。
  支持小红书(3:4)、抖音(9:16)、公众号(16:9)、知识星球(1:1)、掘金(16:9)。 触发：''生成封面''、''封面生成''、''cover''、''thumbnail''、''封面图''、''缩略图''。
